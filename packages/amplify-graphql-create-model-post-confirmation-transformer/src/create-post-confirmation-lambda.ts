...
export const createLambda = (host: TransformHostProvider, stackManager: StackManagerProvider) => {
  const baseName = 'CreatePostConfirmation';
...
//     console.log(`Found existing data source ${lambdaDataSourceName}`);
