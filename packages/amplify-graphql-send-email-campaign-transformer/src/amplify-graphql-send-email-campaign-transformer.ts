import {
  ...
  const FUNCTION_DIRECTIVE_STACK = 'TestFunctionDirectiveStack';
  const directiveDefinition = /* GraphQL */ `
    directive @testFunction(name: String!, region: String, accountId: String) repeatable on FIELD_DEFINITION
  `;
  ...
  export class FunctionTransformer extends TransformerPluginBase {
    ...
    constructor() {
      super('amplify-test-function-transformer', directiveDefinition);
    }
