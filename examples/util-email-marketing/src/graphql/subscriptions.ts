...
>;
export const onCreateEmailListsEmailCampaigns = /* GraphQL */ `subscription OnCreateEmailListsEmailCampaigns(
  $filter: ModelSubscriptionEmailListsEmailCampaignsFilterInput
) {
  onCreateEmailListsEmailCampaigns(filter: $filter) {
    id
    emailCampaignId
    emailListName
    emailCampaign {
...
` as GeneratedSubscription<
  APITypes.OnCreateEmailListsEmailCampaignsSubscriptionVariables,
  APITypes.OnCreateEmailListsEmailCampaignsSubscription
>;
export const onUpdateEmailListsEmailCampaigns = /* GraphQL */ `subscription OnUpdateEmailListsEmailCampaigns(
  $filter: ModelSubscriptionEmailListsEmailCampaignsFilterInput
) {
  onUpdateEmailListsEmailCampaigns(filter: $filter) {
    id
    emailCampaignId
    emailListName
    emailCampaign {
...
` as GeneratedSubscription<
  APITypes.OnUpdateEmailListsEmailCampaignsSubscriptionVariables,
  APITypes.OnUpdateEmailListsEmailCampaignsSubscription
>;
export const onDeleteEmailListsEmailCampaigns = /* GraphQL */ `subscription OnDeleteEmailListsEmailCampaigns(
  $filter: ModelSubscriptionEmailListsEmailCampaignsFilterInput
) {
  onDeleteEmailListsEmailCampaigns(filter: $filter) {
    id
    emailCampaignId
    emailListName
    emailCampaign {
...
` as GeneratedSubscription<
  APITypes.OnDeleteEmailListsEmailCampaignsSubscriptionVariables,
  APITypes.OnDeleteEmailListsEmailCampaignsSubscription
>;
