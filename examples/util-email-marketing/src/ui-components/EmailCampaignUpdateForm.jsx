...
import { EmailCampaign, EmailList, EmailListsEmailCampaigns } from "../models";
import {
  fetchByPath,
  getOverrideProps,
  useDataStoreBinding,
...
export default function EmailCampaignUpdateForm(props) {
  ...
  React.useEffect(resetStateValues, [emailCampaignRecord, linkedEmailLists]);
              ...
              (r) =>
                r.and((r) => {
                  return [
                    ...
                    r.emailCampaignId.eq(emailCampaignRecord.id),
                  ];
                })
            );
              ...
              promises.push(
                DataStore.save(
                  new EmailListsEmailCampaigns({
                    emailCampaign: emailCampaignRecord,
