...
import { EmailList, EmailCampaign, EmailRecipient } from "../models";
...
export declare type EmailListUpdateFormValidationValues = {
    ...
    emailCampaigns?: ValidationFunction<EmailCampaign>;
...
export declare type EmailListUpdateFormOverridesProps = {
    ...
    emailCampaigns?: PrimitiveOverrideProps<AutocompleteProps>;
